                        ...
                        <tbody>
                          <tr>
                            <td style="width:150px;">
                              <img height="auto" src="{{ url('frondend/images/logo.png') }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <tbody>
                          <tr>
                            <td style="width:550px;">
                              <img height="auto" alt="" src="{{ url($data->travel_package->galleries[0]->image) }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
                          ...
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              <div style="font-family:Assistant, Helvetica, Arial, Sans-serif;font-size:18px;line-height:28px;text-align:left;color:#071c4d;">Hi, {{ $data->user->name }} <br>
                                <br> Tiket Digital Kamu Sudah Berhasil Di Cetak. <br> Booking ID <strong>#{{ $data->id }}</strong>
                              </div>
                            </td>
                          </tr>
                          <tr>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                        <tr>
                          <td style="width: 50px;"><img width="50px" src="{{ url('frondend/images/ic_event.png') }}"></td>
                          <td style="font-size:18px; padding-left:10px; color:#071c4d; font-family:Assistant, Helvetica, Arial, Sans-serif; "> Suport@dewa.id <br> 08957245728 </td>
                        <tr>
                      </table>
                    </td>
                  </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Assistant, Helvetica, Arial, Sans-serif;font-size:18px;line-height:1;text-align:center;color:#888b93;">2020 Dewa Travel Copyright All Rights Reserved</div>
                    </td>
                  </tr>
                </table>
              </div>
